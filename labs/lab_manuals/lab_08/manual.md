# Lab 8 · Recursion and References

**Module 8 · Lectures L15–L16 · Week 8 · 120 minutes · guided/independent 50/50**

Prerequisites: completion of Labs 1–7 (Lab 1: none). Bring your laptop
...
- Pass by value vs by reference and observe the difference
- Write reference out-parameters
- Identify base case, recursive case, and termination
- Convert a simple loop to recursion and back
...
passing modes, out-parameters, base/recursive cases — full treatment in the
...
1. What does a reference parameter change about the call?
2. In factorial, what guarantees termination?
3. Why does recursion depth matter (implementation-defined stack)?

## 6. Instructor demonstration (15 min)

The instructor or TA demonstrates: **References, passing modes, recursion basics**. Watch for the *workflow*
...
1. guided: value vs reference vs pointer demonstration
2. guided: factorial and digitSum recursion with traces
3. independent: recursive power(x,n) with a negative-n contract
4. independent: iterative-to-recursive conversion of a supplied sum loop
...
**A swap that fails by value — predict, verify, fix two ways**
...
reliably pass by value vs by reference and observe the difference; write reference out-parameters; identify base case, recursive case, and termination; convert a simple loop to recursion and back. This maps to the module's PF outcomes and feeds
