# Lab 8 TA Notes — INSTRUCTOR-ONLY
...
| Segment | Time | What |
|---|---|---|
| Demo | 0:00–0:15 | References, passing modes, recursion basics |
| Guided tasks + checkpoints | 0:15–1:00 | sign off § 7 guided items |
| Independent work | 1:00–1:45 | record completion only |
| Debug task | 1:45–2:00 | A swap that fails by value — predict, verify, fix two ways |
...
- Lab 8 specific: watch for the § 9 bug being "fixed" without diagnosis —
