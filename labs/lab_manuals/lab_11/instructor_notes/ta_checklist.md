# Lab 11 TA Notes — INSTRUCTOR-ONLY
...
| Segment | Time | What |
|---|---|---|
| Demo | 0:00–0:15 | char processing, std::string operations, parsing |
| Guided tasks + checkpoints | 0:15–1:00 | sign off § 7 guided items |
| Independent work | 1:00–1:45 | record completion only |
| Debug task | 1:45–2:00 | The double-space word-count bug — robust counter required |
...
- Lab 11 specific: watch for the § 9 bug being "fixed" without diagnosis —
