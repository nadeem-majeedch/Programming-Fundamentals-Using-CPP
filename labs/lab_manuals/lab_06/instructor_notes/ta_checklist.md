# Lab 6 TA Notes — INSTRUCTOR-ONLY
...
| Segment | Time | What |
|---|---|---|
| Demo | 0:00–0:15 | IPO, decomposition, trace tables, test design |
| Guided tasks + checkpoints | 0:15–1:00 | sign off § 7 guided items |
| Independent work | 1:00–1:45 | record completion only |
| Debug task | 1:45–2:00 | Trace-table sprint: trace 2 supplied programs by hand, then verify |
...
- Lab 6 specific: watch for the § 9 bug being "fixed" without diagnosis —
