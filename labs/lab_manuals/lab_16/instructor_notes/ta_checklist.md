# Lab 16 TA Notes — INSTRUCTOR-ONLY
...
| Segment | Time | What |
|---|---|---|
| Demo | 0:00–0:15 | Class design, encapsulation, invariants — graded demo |
| Guided tasks + checkpoints | 0:15–1:00 | sign off § 7 guided items |
| Independent work | 1:00–1:45 | record completion only |
| Debug task | 1:45–2:00 | Peer design review against the invariant checklist before coding |
...
- Lab 16 specific: watch for the § 9 bug being "fixed" without diagnosis —
