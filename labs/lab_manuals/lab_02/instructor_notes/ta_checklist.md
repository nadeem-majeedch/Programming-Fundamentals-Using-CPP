# Lab 2 TA Notes — INSTRUCTOR-ONLY
...
| Segment | Time | What |
|---|---|---|
| Demo | 0:00–0:15 | Types, initialization, formatted I/O |
| Guided tasks + checkpoints | 0:15–1:00 | sign off § 7 guided items |
| Independent work | 1:00–1:45 | record completion only |
| Debug task | 1:45–2:00 | A calculator whose totals silently truncate — diagnose, then fix |
...
- Lab 2 specific: watch for the § 9 bug being "fixed" without diagnosis —
