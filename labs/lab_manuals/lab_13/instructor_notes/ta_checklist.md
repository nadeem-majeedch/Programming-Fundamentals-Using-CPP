# Lab 13 TA Notes — INSTRUCTOR-ONLY
...
| Segment | Time | What |
|---|---|---|
| Demo | 0:00–0:15 | Addresses, dereference, pointer safety |
| Guided tasks + checkpoints | 0:15–1:00 | sign off § 7 guided items |
| Independent work | 1:00–1:45 | record completion only |
| Debug task | 1:45–2:00 | Three pointer hazards clinic (uninitialized, null, dangling) — guarded fixes |
...
- Lab 13 specific: watch for the § 9 bug being "fixed" without diagnosis —
