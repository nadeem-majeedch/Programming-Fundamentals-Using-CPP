# Lab 10 TA Notes — INSTRUCTOR-ONLY
...
| Segment | Time | What |
|---|---|---|
| Demo | 0:00–0:15 | Grid traversal, row/column logic |
| Guided tasks + checkpoints | 0:15–1:00 | sign off § 7 guided items |
| Independent work | 1:00–1:45 | record completion only |
| Debug task | 1:45–2:00 | Boundary-walk bug: corner double-count in a border sum — fix |
...
- Lab 10 specific: watch for the § 9 bug being "fixed" without diagnosis —
