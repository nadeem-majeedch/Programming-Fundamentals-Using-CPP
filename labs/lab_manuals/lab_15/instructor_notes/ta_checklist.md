# Lab 15 TA Notes — INSTRUCTOR-ONLY
...
| Segment | Time | What |
|---|---|---|
| Demo | 0:00–0:15 | Streams, robust reading, error strategies |
| Guided tasks + checkpoints | 0:15–1:00 | sign off § 7 guided items |
| Independent work | 1:00–1:45 | record completion only |
| Debug task | 1:45–2:00 | Robustness clinic: 3 fault injections (missing file, bad line, empty file) |
...
- Lab 15 specific: watch for the § 9 bug being "fixed" without diagnosis —
