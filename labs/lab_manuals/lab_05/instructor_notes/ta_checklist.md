# Lab 5 TA Notes — INSTRUCTOR-ONLY
...
| Segment | Time | What |
|---|---|---|
| Demo | 0:00–0:15 | while/do-while/for, sentinels, accumulation |
| Guided tasks + checkpoints | 0:15–1:00 | sign off § 7 guided items |
| Independent work | 1:00–1:45 | record completion only |
| Debug task | 1:45–2:00 | A missing-update infinite loop — spot it BEFORE running (then run) |
...
- Lab 5 specific: watch for the § 9 bug being "fixed" without diagnosis —
