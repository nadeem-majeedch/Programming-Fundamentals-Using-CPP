# Lab 14 TA Notes — INSTRUCTOR-ONLY
...
| Segment | Time | What |
|---|---|---|
| Demo | 0:00–0:15 | struct records, new/delete with the RAII alternative |
| Guided tasks + checkpoints | 0:15–1:00 | sign off § 7 guided items |
| Independent work | 1:00–1:45 | record completion only |
| Debug task | 1:45–2:00 | Leak hunt: classify 3 supplied snippets, fix with RAII or paired delete |
...
- Lab 14 specific: watch for the § 9 bug being "fixed" without diagnosis —
