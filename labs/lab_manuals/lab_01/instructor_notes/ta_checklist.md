# Lab 1 TA Notes — INSTRUCTOR-ONLY
...
| Segment | Time | What |
|---|---|---|
| Demo | 0:00–0:15 | Toolchain & edit-compile-run cycle |
| Guided tasks + checkpoints | 0:15–1:00 | sign off § 7 guided items |
| Independent work | 1:00–1:45 | record completion only |
| Debug task | 1:45–2:00 | A program with 3 planted errors (one per stage) — classify each before fixing |
...
- Lab 1 specific: watch for the § 9 bug being "fixed" without diagnosis —
