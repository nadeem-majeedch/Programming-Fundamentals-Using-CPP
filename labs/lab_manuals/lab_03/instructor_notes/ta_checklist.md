# Lab 3 TA Notes — INSTRUCTOR-ONLY
...
| Segment | Time | What |
|---|---|---|
| Demo | 0:00–0:15 | Precedence, division/modulo, conversions |
| Guided tasks + checkpoints | 0:15–1:00 | sign off § 7 guided items |
| Independent work | 1:00–1:45 | record completion only |
| Debug task | 1:45–2:00 | Expression workbench: predict 8 mixed expressions, run, reconcile |
...
- Lab 3 specific: watch for the § 9 bug being "fixed" without diagnosis —
