...
**Module 3 · Lectures L05–L06 · Week 3 · 120 minutes · guided/independent 70/30**

Prerequisites: completion of Labs 1–2 (Lab 1: none). Bring your laptop
...
- Predict expression values using precedence and associativity
- Use / and % for digit and unit extraction
- Explain implicit conversions and cast explicitly with static_cast
- Write compound conditions with && || !
...
precedence table use, % patterns, explicit casts — full treatment in the
...
1. What is the value of 2 + 3 * 4 % 5 — and why?
2. 17 / 5 and 17 % 5: which pair reconstructs 17?
3. What does the standard guarantee for the sign of (-7) % 2? (discuss standard vs textbook claims)

## 6. Instructor demonstration (15 min)

The instructor or TA demonstrates: **Precedence, division/modulo, conversions**. Watch for the *workflow*
...
1. guided: precedence prediction rounds (4 expressions)
2. guided: minutes-to-hh:mm with / and %
3. independent: digit extractor (3-digit number to digits) with casts
4. independent: compound interest with cast documentation
...
**Expression workbench: predict 8 mixed expressions, run, reconcile**
...
reliably predict expression values using precedence and associativity; use / and % for digit and unit extraction; explain implicit conversions and cast explicitly with static_cast; write compound conditions with && || !. This maps to the module's PF outcomes and feeds
