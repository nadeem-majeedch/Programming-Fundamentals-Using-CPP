# Lab 7 TA Notes — INSTRUCTOR-ONLY
...
| Segment | Time | What |
|---|---|---|
| Demo | 0:00–0:15 | Decomposition into tested functions |
| Guided tasks + checkpoints | 0:15–1:00 | sign off § 7 guided items |
| Independent work | 1:00–1:45 | record completion only |
| Debug task | 1:45–2:00 | Refactor a 60-line main into 3 functions — one responsibility each |
...
- Lab 7 specific: watch for the § 9 bug being "fixed" without diagnosis —
