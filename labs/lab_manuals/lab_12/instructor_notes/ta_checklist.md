# Lab 12 TA Notes — INSTRUCTOR-ONLY
...
| Segment | Time | What |
|---|---|---|
| Demo | 0:00–0:15 | Search correctness, sort tracing, complexity intuition |
| Guided tasks + checkpoints | 0:15–1:00 | sign off § 7 guided items |
| Independent work | 1:00–1:45 | record completion only |
| Debug task | 1:45–2:00 | Binary search boundary bug (low < high vs <=) — diagnose and fix |
...
- Lab 12 specific: watch for the § 9 bug being "fixed" without diagnosis —
